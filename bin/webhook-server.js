  ...
  _createClass(TrelloWebhookServer, [{
    ...
    value: function start(idModel) {
      ...
      return httpServer(this._port, this.httpHandler.bind(this)).then(function () {
        return _this2.registerWebhook(idModel);
      });
    }
  }, {
    key: 'on',
    ...
    key: 'registerWebhook',
    value: function registerWebhook(idModel) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        _this3._trello.post('/1/webhooks', {
          description: 'Trello Webhook Server',
          callbackURL: _this3._callbackURL,
          idModel: idModel
        }, function (err, data) {
          if (err) {
            return reject(err);
          ...
          _this3._webhookID = data.id;
          return resolve(_this3._webhookID);
        });
      });
    }
  }, {
    ...
    value: function httpHandler(req, response) {
      ...
      if (req.method.toLowerCase() === 'head') {
        ...
        (function () {
          ...
          req.on('end', function () {
            try {
              if (!verifyTrelloWebhookRequest(_this4._callbackURL, _this4._clientSecret, trelloEvent, req.headers['x-trello-webhook'] || '')) {
                res.statusCode = 400;
                res.end();
                return;
              }
              ...
              try {
                for (var _iterator = handlers[_this4._idModel].data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
